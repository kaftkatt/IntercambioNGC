...
for i in range(12):
    Q[:,:,i]=out*-950*((gaussian(np.arange(12), 5.5, 2)-np.min(gaussian(np.arange(12), 5.5, 2)))*5)[11-i]
...
T_mask[:,:,0:20]=maskin[0:20]/np.max(maskin) #To make the values between 0-1. 
